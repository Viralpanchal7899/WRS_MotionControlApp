...
public class thigh_calibration extends AppCompatActivity {
    ...
    private int eig_index_1_r;
    private int eig_index_1_l;
...
//                display5(axis2);
    ...
    public void CrossProduct_r(){
        cross_P_i = (Eigen_vectors_1[1][eig_index_1_r]*Eigen_vectors_2[2][eig_index_2_r] - Eigen_vectors_1[2][eig_index_1_r]*Eigen_vectors_2[1][eig_index_2_r]);
...
//        display6(axis3);
    ...
    public void CrossProduct_l(){
        cross_P_i = (Eigen_vectors_1[1][eig_index_1_l]*Eigen_vectors_2[2][eig_index_2_l] - Eigen_vectors_1[2][eig_index_1_l]*Eigen_vectors_2[1][eig_index_2_l]);
...
//        display6(axis3);
    ...
    public void R_IMU_Pelvis_r(){
        final DecimalFormat df = new DecimalFormat("0.0000");
        R_IMU_Pelvis_r = "R_r = [ " + df.format(Eigen_vectors_1[0][eig_index_1_r]) + "   " + df.format(Eigen_vectors_1[1][eig_index_1_r]) + "   " + df.format(Eigen_vectors_1[2][eig_index_1_r]) + " \n " + "     " +  df.format(Eigen_vectors_1[2][eig_index_1_r]) + "   " + df.format(Eigen_vectors_2[1][eig_index_2_r]) + "   " + df.format(Eigen_vectors_2[2][eig_index_2_r]) + " \n " + "     " + df.format(cross_P_i) + "   " + df.format(cross_P_j) + "   " + df.format(cross_P_z) + " ]";
    }

    public void R_IMU_Pelvis_l(){
        final DecimalFormat df = new DecimalFormat("0.0000");
        R_IMU_Pelvis_l = "R_l = [ " + df.format(Eigen_vectors_1[0][eig_index_1_l]) + "   " + df.format(Eigen_vectors_1[1][eig_index_1_l]) + "   " + df.format(Eigen_vectors_1[2][eig_index_1_l]) + " \n " + "     " +  df.format(Eigen_vectors_1[2][eig_index_1_l]) + "   " + df.format(Eigen_vectors_2[1][eig_index_2_l]) + "   " + df.format(Eigen_vectors_2[2][eig_index_2_l]) + " \n " + "     " + df.format(cross_P_i) + "   " + df.format(cross_P_j) + "   " + df.format(cross_P_z) + " ]";
    }
}